...
public class ProfileFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		profile_pic = (ProfilePictureView) activity
		...
		if (args == null || args.getString("UserID", "").isEmpty()) {
			...
			text_name.setText(prefs.getString("FirstName", "Fname") + " "
			...
			text_name.setText(args.getString("FirstName", "Fname") + " "
					+ args.getString("LastName", "Lname"));
